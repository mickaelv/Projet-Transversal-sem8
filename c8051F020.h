...
/*  SCON1  0xF1 */
sbit SM01  = 0xF8;             /* SERIAL MODE CONTROL BIT 0           */
sbit SM11  = 0xF7;             /* SERIAL MODE CONTROL BIT 1           */
sbit SM21  = 0xF6;             /* MULTIPROCESSOR COMMUNICATION ENABLE */
sbit REN1  = 0xF5;             /* RECEIVE ENABLE                      */
sbit TB81  = 0xF4;             /* TRANSMIT BIT 8                      */
sbit RB81  = 0xF3;             /* RECEIVE BIT 8                       */
sbit TI1   = 0xF2;             /* TRANSMIT INTERRUPT FLAG             */
sbit RI1   = 0xF1;             /* RECEIVE INTERRUPT FLAG              */
